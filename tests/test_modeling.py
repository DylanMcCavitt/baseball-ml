        ...
        pitcher_rows.append(
            {
                ...
                "pitcher_k_rate_vs_rhh": row.get("pitcher_k_rate_vs_rhh"),
                "pitcher_k_rate_vs_lhh": row.get("pitcher_k_rate_vs_lhh"),
                "swinging_strike_rate": row["swinging_strike_rate"],
                "pitcher_whiff_rate_vs_rhh": row.get("pitcher_whiff_rate_vs_rhh"),
                "pitcher_whiff_rate_vs_lhh": row.get("pitcher_whiff_rate_vs_lhh"),
        ...
        lineup_rows.append(
            {
                ...
                "lineup_k_rate_vs_rhp": row.get("lineup_k_rate_vs_rhp"),
                "lineup_k_rate_vs_lhp": row.get("lineup_k_rate_vs_lhp"),
        ...
        game_context_rows.append(
            {
                ...
                "park_k_factor": 1.02,
                "park_k_factor_vs_rhh": 1.02,
                "park_k_factor_vs_lhh": 1.03,
                "park_factor_status": "ok",
                "rest_days": row["rest_days"],
